...
/**
 * Toolbar genérico de filtros sobre jugadores: search por nombre + select de
 * categoría. Pensado para unificar la experiencia en /admin/payments,
 * /admin/documents y cualquier otra pantalla que liste por jugador.
 *
 * Persiste como ?q=&cat= y conserva el resto de los searchParams.
 */
